...
class App {
  ...
  _loadMap(position) {
    ...
    //handling clicks on map (event listener from Leaflet lib)
  ...
  // add this in empty space bellow when ready!
  ...
  _moveToPopup(e) {
    ...
    // console.log(workoutEl);
    // if (e.target == e.target.closest('.delete-button')) this._deleteWorkout(e);
  }
  ...
  //   this.#workouts.forEach((rec, i) => {
  //     delElId =
  //       rec.id === e.target.closest('.workout').dataset.id ? rec.id : delElId;
  //   });
  //   console.log(delElId);
  //   window.localStorage.removeItem('.workouts'[0]);
